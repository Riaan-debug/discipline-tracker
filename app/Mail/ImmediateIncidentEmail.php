...
class ImmediateIncidentEmail extends Mailable implements ShouldQueue
{
    ...
    public function envelope(): Envelope
    {
        ...
        return new Envelope(
            subject: 'URGENT: Critical Incident Report - ' . $this->student->full_name . ' - ' . $schoolName,
        );
    }
    ...
    {
        return new Content(
            view: 'emails.immediate-incident',
            with: [
