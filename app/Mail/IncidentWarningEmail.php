...
class IncidentWarningEmail extends Mailable implements ShouldQueue
{
    ...
    public function envelope(): Envelope
    {
        ...
        return new Envelope(
            subject: 'Student Behavior Update - ' . $this->student->full_name . ' - ' . $schoolName,
        );
    }
