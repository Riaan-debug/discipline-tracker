...
class DisciplinaryHearingEmail extends Mailable implements ShouldQueue
{
    ...
    public function envelope(): Envelope
    {
        ...
        return new Envelope(
            subject: 'DISCIPLINARY HEARING NOTICE - ' . $this->student->full_name . ' - ' . $schoolName,
        );
    }
    ...
    {
        return new Content(
            view: 'emails.disciplinary-hearing',
            with: [
